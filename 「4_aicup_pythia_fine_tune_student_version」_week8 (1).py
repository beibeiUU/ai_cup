# -*- coding: utf-8 -*-
"""「4. AICUP_Pythia fine tune_STUDENT VERSION」_week8.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CFAUzvW-qLOkmQwiKbUeZ9jkTfs1OdRU
"""
...
import torch
sub_datasets = torch.utils.data.random_split(dataset['train'], [10 , len(dataset['train'])-10])
print(len(sub_datasets[0]))
# for i in range(4): print(sub_datasets[0][i])
for i in range(len(sub_datasets[0])):
  print(sub_datasets[0][i])
